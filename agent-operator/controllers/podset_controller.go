...
func (r *PodSetReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	instance := &agentoperatorv1beta1.PodSet{}
	...
	status := agentoperatorv1beta1.PodSetStatus{
...
func newPodForCR(cr *agentoperatorv1beta1.PodSet) *corev1.Pod {
...
func (r *PodSetReconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&agentoperatorv1beta1.PodSet{}).
		Owns(&corev1.Pod{}).
		Complete(r)
}
