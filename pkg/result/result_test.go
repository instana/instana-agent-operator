...
func TestOfInline(t *testing.T) {
	...
	rslt := OfInline(func() (res string, err error) {
...
func TestResult_IsSuccess(t *testing.T) {
	t.Run("empty_val_nil_error", func(t *testing.T) {
		assertions := require.New(t)

		rslt := Of("", nil)
		assertions.True(rslt.IsSuccess())
	})
	t.Run("empty_val_non_nil_error", func(t *testing.T) {
		assertions := require.New(t)

		rslt := Of("", errors.New("asdf"))
		assertions.False(rslt.IsSuccess())
	})
	t.Run("non_empty_val_nil_error", func(t *testing.T) {
		assertions := require.New(t)

		rslt := Of("jljsd;lfjads", nil)
		assertions.True(rslt.IsSuccess())
	})
	t.Run("non_empty_val_non_nil_error", func(t *testing.T) {
		assertions := require.New(t)
...
func TestResult_OnSuccess(t *testing.T) {
	t.Run("with_nil_error", func(t *testing.T) {
		...
		rslt := Of(5, nil)
		rsltCopy := rslt.OnSuccess(func(i int) {
			actual = i
		})
...
func TestResult_OnFailure(t *testing.T) {
	t.Run("with_nil_error", func(t *testing.T) {
		...
		rslt := Of(5, nil)
		rsltCopy := rslt.OnFailure(func(err error) {
...
func TestMap(t *testing.T) {
	t.Run("with_nil_error", func(t *testing.T) {
		...
		rslt := Of("9", nil)
		mappedResult := Map[string, int](rslt, func(str string) Result[int] {
