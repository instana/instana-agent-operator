...
func TestClusterRoleBindingBuilder_Build(t *testing.T) {
	...
	helpers.On("ClusterScopedK8sSensorRBACName").Return(clusterScopedName).Times(2)
	helpers.On("K8sSensorResourcesName").Return(k8sSensorName).Once()
