...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AutotraceWebhookSpec) DeepCopyInto(out *AutotraceWebhookSpec) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AutotraceWebhookSpec.
func (in *AutotraceWebhookSpec) DeepCopy() *AutotraceWebhookSpec {
	if in == nil {
		return nil
	}
	out := new(AutotraceWebhookSpec)
	in.DeepCopyInto(out)
	return out
}
...
func (in *InstanaAgentSpec) DeepCopyInto(out *InstanaAgentSpec) {
	*out = *in
	...
	out.ServiceMesh = in.ServiceMesh
	in.AutotraceWebhook.DeepCopyInto(&out.AutotraceWebhook)
}
