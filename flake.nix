{
  description = "A nix-flake-based Go/Kubernetes Controller development environment using operator-sdk";
  ...
  outputs =
    ...
    let
      ...
      matchingLines = builtins.filter (line: builtins.match regex line != null) lines;
      # Get the version string i.e: "1.23"
      versionString = builtins.elemAt (builtins.match regex (builtins.concatStringsSep " " matchingLines)) 0;
